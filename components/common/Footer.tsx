...
export default function Footer() {
    return (
        <footer className="bg-text-primary text-white">
            {/* Main Footer */}
            <div className="max-w-7.5xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
                        ...
                        <div className="flex gap-4">
                            {[Facebook, Instagram, Linkedin, Youtube].map((Icon, index) => (
                                <a
                                    key={index}
                                    href="#"
                                    className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/70 hover:bg-leaf-500 hover:text-white transition-all duration-300"
                                >
                                    <Icon size={18} />
                                </a>
                            ))}
            ...
            <div className="border-t border-white/10">
                <div className="max-w-7.5xl mx-auto px-6 lg:px-8 py-6">
