            ...
            <div className="grid lg:grid-cols-[1fr,auto] gap-8 items-center">
              ...
              <div className="flex lg:flex-col gap-4">
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-leaf-600 transition-colors"
                >
                  <ChevronLeft size={24} />
                </button>
                <button
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  index === current ? 'bg-leaf-500 w-8' : 'bg-white/30 hover:bg-white/50'
                }`}
              />
            ))}
          </div>
