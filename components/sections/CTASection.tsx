        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-8 py-4 bg-leaf-600 text-white font-semibold rounded-full hover:bg-leaf-700 transition-all duration-300 hover:shadow-xl hover:shadow-leaf-200 hover:-translate-y-1"
              >
                Book Appointment
                <ArrowRight size={18} />
              </Link>
              <a
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-text-primary font-semibold rounded-full border border-gray-200 hover:border-leaf-300 transition-all duration-300"
              >
                <Phone size={18} />
                +91 33 1234 5678
              </a>
