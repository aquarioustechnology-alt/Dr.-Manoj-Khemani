    ...
    if (variant === 'primary') {
        return (
            ...
            >
                ...
                <div className={`relative flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 bg-white rounded-full transition-all duration-300 group-hover:bg-transparent group-hover:text-white shrink-0 mr-3 ${iconClassName || 'text-leaf-500'}`}>
