...
export default function Hero() {
    ...
    return (
        <section className={`relative lg:sticky top-0 z-0 w-full bg-[#f8faf5] transition-all duration-300 lg:overflow-visible 2xl:overflow-hidden ${isVideoOpen ? 'z-[60]' : 'z-0'}`}>
            <div ref={contentRef} className="relative min-h-[600px] md:min-h-[650px] lg:min-h-[600px] xl:min-h-[650px] 2xl:min-h-[750px] flex flex-col lg:block">
                ...
                <div className="relative z-10 max-w-7.5xl mx-auto px-3 lg:px-5 pt-44 lg:pt-[170px] xl:pt-[170px] 2xl:pt-[170px] pb-8 lg:pb-[30px] xl:pb-[40px] 2xl:pb-[60px] order-1 lg:order-none flex flex-col items-center lg:block lg:text-left text-center">
                    <div className="max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-[55%] xl:max-w-[58%] 2xl:max-w-[60%] w-full">
                        {/* Badge */}
                        ...
                        {/* Heading */}
                        <h1 className="hero-content-item text-[34px] sm:text-[44px] md:text-[52px] lg:text-[60px] xl:text-[60px] 2xl:text-[60px] font-bold text-text-primary mb-1 sm:mb-6 leading-[1.05] mx-auto lg:mx-0">
                ...
                <div className="hero-content-item hidden lg:flex absolute bottom-[52%] lg:bottom-[62%] xl:bottom-[58%] 2xl:bottom-[50%] left-[60%] xl:left-[63%] 2xl:left-[60%] z-20 items-center gap-4 bg-white/95 backdrop-blur-sm rounded-[20px] pl-2 pr-8 py-2 shadow-xl ring-1 ring-leaf-200/50 transition-all duration-500">
                ...
                <div className="hero-content-item hidden lg:block absolute bottom-[22%] lg:bottom-[32%] xl:bottom-[28%] 2xl:bottom-[20%] left-[60%] xl:left-[63%] 2xl:left-[60%] z-20">
