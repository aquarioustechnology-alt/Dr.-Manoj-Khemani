...
export default function AboutPreview() {
    ...
    return (
        <section ref={sectionRef} className="py-20 lg:pt-[100px] lg:pb-32 bg-[#F9F9F9] relative z-10 rounded-t-[3rem] shadow-[0_-20px_60px_-15px_rgba(0,0,0,0.05)]">
            <div className="w-full max-w-[1600px] mx-auto px-6 lg:px-20">
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-[1fr_1.8fr] gap-8 items-end">
                        ...
                        {/* Beside: Doctor Image (Taller) */}
                        <div className="about-bottom-col relative h-[500px] lg:h-[700px]">
                            <div className="relative w-full h-full rounded-[2rem] overflow-hidden border-8 border-white">
                                <img
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-8 lg:pt-10">
                        <div>
                            ...
                            <p className="text-base text-gray-600 leading-relaxed about-top-content mb-10 font-medium">
                                <span className="font-bold text-black border-b-2 border-leaf-200">Dr. Manoj Kumar Khemani</span> is a senior Orthopaedic Surgeon based in Kolkata, India, with <span className="font-bold text-black underline decoration-leaf-300 decoration-2 underline-offset-4">over 20 years of clinical experience</span>. He is known for his expertise in knee and hip joint replacement, complex fracture management, and minimally invasive arthroscopic procedures.
                            </p>

                            {/* Membership Card */}
                            <div className="about-bottom-col bg-white rounded-[2.5rem] p-8 shadow-xl shadow-gray-100/50 border border-gray-100">
                                <h4 className="text-sm font-bold text-gray-800 mb-6 flex items-center gap-2">
                                    <Award size={18} className="text-leaf-500" /> Professional Memberships
                                </h4>
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        <li key={index} className="flex items-start gap-3 text-gray-600">
                                            ...
                                            <span className="text-[13px] font-medium leading-tight">{item}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
